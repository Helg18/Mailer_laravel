...
<div class="container-fluid">
  <div class="row">
    <div align="left">
      <a href="{{ route('Admin.Addemail.create') }}" class="label label-info"><i class="glyphicon glyphicon-plus"></i> Agregar email</a>
    </div>
...
@foreach($correos as $correo)
    <tr>
     ...
     <td width="15%">
      <a href="" class="label label-warning"><i class="glyphicon glyphicon-pencil"></i></a> | 
